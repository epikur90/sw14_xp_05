...
public class DataProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI_MESSAGES = Uri.parse("content://com.sw14_xp_05.pinkee.provider/messages");
	public static final Uri CONTENT_URI_PROFILE = Uri.parse("content://com.sw14_xp_05.pinkee.provider/profile");
	...
	static {
		...
		uriMatcher.addURI("com.sw14_xp_05.pinkee.provider", "messages", MESSAGES_ALLROWS);
		uriMatcher.addURI("com.sw14_xp_05.pinkee.provider", "messages/#", MESSAGES_SINGLE_ROW);
		uriMatcher.addURI("com.sw14_xp_05.pinkee.provider", "profile", PROFILE_ALLROWS);
		uriMatcher.addURI("com.sw14_xp_05.pinkee.provider", "profile/#", PROFILE_SINGLE_ROW);
	}
